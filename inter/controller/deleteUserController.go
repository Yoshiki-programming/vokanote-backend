...
func DeleteUserController(ctx context.Context, firestoreClient *firestore.Client, uid string) (int, []byte, error) {
	...
	if err != nil {
		fmt.Errorf("failed to find user for deletion: %v", err)
		// ユーザーが見つからない場合は 404
